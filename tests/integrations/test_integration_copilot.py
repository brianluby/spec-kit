...
class TestCopilotIntegration:
    ...
    def test_complete_file_inventory_sh(self, tmp_path):
        ...
        expected = sorted([
            ...
            ".github/agents/speckit.architecture.agent.md",
            ".github/agents/speckit.prd.agent.md",
            ".github/agents/speckit.security.agent.md",
            ...
            ".github/prompts/speckit.architecture.prompt.md",
            ".github/prompts/speckit.prd.prompt.md",
            ".github/prompts/speckit.security.prompt.md",
            ...
            ".specify/scripts/bash/configure-worktree.sh",
            ...
            ".specify/templates/ar-template.md",
            ".specify/templates/prd-template.md",
            ".specify/templates/roadmap-template-v1.md",
            ".specify/templates/sec-template.md",
            ".specify/templates/vision-template-v1.md",
    ...
    def test_complete_file_inventory_ps(self, tmp_path):
        ...
        expected = sorted([
            ...
            ".specify/scripts/powershell/configure-worktree.ps1",
