...
| `--ai-skills`          | Flag     | Generate agent skills from command templates; requires `--ai`                                                                                                                                |
| `--ai-commands-dir`    | Option   | Custom commands directory to use with `--ai generic`; required when using `generic`                                                                                                          |
